...
* { box-sizing: border-box; font-family: sans-serif; }
  ...
  #settings-card { position: fixed; width: 280px; background: white; padding: 20px; border-radius: 15px; display: none; box-shadow: 0 10px 40px rgba(0,0,0,0.3); z-index: 1000000; }
